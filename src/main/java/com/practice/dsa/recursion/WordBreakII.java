...
public class WordBreakII {
  ...
  private static void recurse(
      String str, Set<String> dict, List<String> result, int start, String currentStr) {
    if (start == str.length()) {
  ...
  private static void recurse(
      int start, int end, List<String> result, List<String> curr, Set<String> dict, String str) {
    if (end == str.length() - 1) {
