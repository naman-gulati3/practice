...
public class RootToNodePath {
  ...
  private static boolean traverse(TreeNode root, List<Integer> currentResult, int val) {
    if (root == null) {
      return false;
    }
  ...
  private static void traverse(
      ArrayList<ArrayList<Integer>> result, TreeNode root, ArrayList<Integer> currentRes) {
    if (root == null) {
      return;
    }
