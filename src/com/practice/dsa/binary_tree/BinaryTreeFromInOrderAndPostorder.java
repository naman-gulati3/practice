...
public class BinaryTreeFromInOrderAndPostorder {
  ...
  private static TreeNode buildTree(int inorderStart, int inorderEnd,
    ...
    root.left = buildTree(inorderStart, inorderRoot - 1, postorder, postorderStart,
        postorderStart + numsLeft - 1, inorderMap);
    root.right = buildTree(inorderRoot + 1, inorderEnd, postorder,
        postorderStart + numsLeft,
        postorderEnd - 1, inorderMap);
