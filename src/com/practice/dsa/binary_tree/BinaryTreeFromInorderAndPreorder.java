...
public class BinaryTreeFromInorderAndPreorder {
  ...
  public static TreeNode buildTree(int[] preorder, int[] inorder) {
    ...
    TreeNode root = buildTree(preorder, 0, preorder.length - 1, 0, inorder.length - 1,
        inorderMap);
  ...
  private static TreeNode buildTree(int[] preorder, int preStart, int preEnd,
    ...
    root.left = buildTree(preorder, preStart + 1, preStart + numsToLeftOfRoot, inorderStart,
        inorderRoot - 1, inorderMap);

    root.right = buildTree(preorder, preStart + numsToLeftOfRoot + 1, preEnd, inorderRoot + 1,
